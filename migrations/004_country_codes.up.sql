...
-- Seeded with all 249 countries/territories from the ISO 3166-1 standard.
CREATE TABLE IF NOT EXISTS public.country_codes
(
    id                       bigserial    CONSTRAINT countries_codes_pkey PRIMARY KEY,
    name                     text         NOT NULL,
    alpha_2                  char(2)      NOT NULL CONSTRAINT uq_iso_3166_alpha_2  UNIQUE
                                                   CONSTRAINT chk_alpha_2_length  CHECK (char_length(alpha_2) = 2),
    alpha_3                  char(3)      NOT NULL CONSTRAINT uq_iso_3166_alpha_3  UNIQUE
                                                   CONSTRAINT chk_alpha_3_length  CHECK (char_length(alpha_3) = 3),
    country_code             char(3)      NOT NULL CONSTRAINT uq_iso_3166_country_code UNIQUE
                                                   CONSTRAINT chk_country_code_length CHECK (char_length(country_code) = 3),
...
-- Grant read access to the app user (matches permission pattern from migration 003).
GRANT SELECT ON TABLE public.country_codes TO skynapi;

-- Seed data: all 249 ISO 3166-1 entries.
...
VALUES
    ...
    ('Netherlands, Kingdom of the', 'NL', 'NLD', '528', 'ISO 3166-2:NL', 'Europe', 'Western Europe', NULL, '150', '155', NULL),
    ...
    ('Taiwan, Province of China', 'TW', 'TWN', '158', 'ISO 3166-2:TW', NULL, NULL, NULL, NULL, NULL, NULL),
    ...
    ('Türkiye', 'TR', 'TUR', '792', 'ISO 3166-2:TR', 'Asia', 'Western Asia', NULL, '142', '145', NULL),
